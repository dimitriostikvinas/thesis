...
\title{Έλεγχος διμερούς ρομποτικού
τηλεχειρισμού με άγνωστες χρονικές
καθυστερήσεις και εγγυήσεις απόδοσης
και ασφάλειας}
\date{15 Νοεμβρίου, 2024}
\author{Δημήτριης Τικβίνας}
